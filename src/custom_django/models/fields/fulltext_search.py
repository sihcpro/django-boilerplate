# -*- coding: utf-8 -*-
# Source: https://github.com/confirm/django-fulltext-search
from django.db import connection, models

from ..__init__ import SManager
...
class SearchQuerySet(models.query.QuerySet):
    ...
    def get_query_set(self, query, columns, mode):
        ...
        where_expression = 'MATCH({}) AGAINST("%s" {})'.format(
            fulltext_columns, mode
        )
